...
//Selecciona todos los elementos con la clase ".tarea" que son arrastrables
...
//Itera sobre cada elemento ".tarea" seleccionado
...
const insertAboveTask = (zona, mouseY) => {
    const els = zona.querySelectorAll(".tarea:not(.is-dragging)");
